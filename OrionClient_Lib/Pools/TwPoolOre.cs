...
{
    public class TwPoolOre : OreHQPool
    {
        public override string Name { get; } = "Twore";
        ...
        public override string ArgName => "twpore";
        ...
        public override string HostName { get; protected set; } = "ore.tw-pool.com";
